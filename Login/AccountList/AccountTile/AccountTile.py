...
class AccountTile(Frame):
    ...
    DEFAULT_ACCOUNT_IMG = "Login/AccountList/AccountTile/account_default_icon.png"
    ACTIVE_ACCOUNT_IMG = "Login/AccountList/AccountTile/active_account_img.png"
    DELETE_BTN_IMG = "Login/AccountList/AccountTile/delete_btn_img.png"

    def __init__(self, genesis_root=None, address=None, callback_reload_list=None, accounts_num=None, deletable=True, **kwargs):
        ...
        self.account_icon_img = PhotoImage(file=self.DEFAULT_ACCOUNT_IMG)
        self.active_account_icon_img = PhotoImage(file=self.ACTIVE_ACCOUNT_IMG)
        self.account_icon_label = Label(
            self,
            image=self.account_icon_img if self.deletable else self.active_account_icon_img
        )
